...
/**
 * Vista para mostrar la ficha de un comedor.
 */
class FichaComedorVista {
    ...
    /**
     * HTML con los datos generales del comedor.
     * @var string
     */
    private $datosGenerales;

    /**
     * HTML con la tabla de horarios.
     * @var string
     */
     ...
     * @param array $horarios Horarios del comedor
     */
    ...
    /**
     * Genera el HTML con los datos generales del comedor.
     * @param array $comedor Datos del comedor
    ...
    /**
     * Genera la tabla HTML de horarios.
     * @param array $horarios Horarios del comedor
     * @return string HTML generado
     */
