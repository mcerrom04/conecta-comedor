...
export default function FichaComedor({ comedor, auth }) {
    ...
    const getEstadoBadge = (estado) => {
        ...
        return badges[estado] || badges.cerrado;
    };

    const estadoBadge = getEstadoBadge(comedor.estado);
                ...
                <main className="py-12">
                    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                        ...
                        {comedor.necesidades && comedor.necesidades.length > 0 && (
                            <div className="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                                <div className="p-6">
                                    <h2 className="text-2xl font-bold mb-4">Necesidades Actuales</h2>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex justify-between items-start mb-2">
                                                        ...
                                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${urgencia.color}`}>
                                                            {urgencia.text}
                                                        </span>
                                                    </div>
